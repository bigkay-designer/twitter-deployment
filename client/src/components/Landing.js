...
function Landing() {
  ...
  const onSubmitHandler = async (e) => {
    ...
    let newUser = { username: username.toLowerCase(), password };
    ...
    axios
      ...
      .then((res) => {
        ...
        localStorage.setItem('t-user', JSON.stringify(res.data.user));
      })
      .catch((err) => {
            ...
            <div className="landing__twitter__join">
              ...
              <Link style={{ textDecoration: 'none' }} to="/signup">
                <Button
                  variant="outlined"
                  fullWidth
                  className="landing__join__btn btn1"
                >
                  Sign up
                </Button>
              </Link>
              <Link style={{ textDecoration: 'none' }} to="/login">
                <Button
                  variant="outlined"
                  fullWidth
                  className="landing__join__btn btn2"
                >
                  Log in
                </Button>
              </Link>
